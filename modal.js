...
const gameData = {
  ...
  poem16:{ type:"digital", title:"Diwali Memory", play:"https://wrath6565.github.io/Navneet_NID_construction_test/Animation/day10/DIwali/", screenshots:["img/Game Poems/ss48.png","img/Game Poems/ss49.png","img/Game Poems/ss50.png","img/Game Poems/ss51.png"], description:"Diwali Memory is an interactive poem that follows a week spent at home during the Diwali festival. In the first playthrough, the player simply moves through each moment — arriving at the airport, returning home, shopping with family, working late, and finally leaving again — all unfolding quickly, just like real life rushing past.\nWhen the week ends, the game asks if you want to relive the memory. This time, the player can move freely, slow down, and revisit each scene with clarity. The second pass transforms the experience into reflection, showing how memories reveal the small details we miss while living the moment." },
  //poem17:{ type:"digital", title:"Poem 17", play:"#", screenshots:["/mnt/data/website.png"], description:"Poem 17 description." },
  poem18:{ type:"digital", title:"Time Flies By", play:"https://varsharaj2199-hub.github.io/NID_VARSHA-RAJ_P5.JS/Game%20Poem/", screenshots:["img/Game Poems/ss52.png","img/Game Poems/ss53.png"], description:"The inspiration for this project came from a recent personal experience. During a visit to my hometown for Diwali, I observed my mother, who continues to work tirelessly for our family even as she has gotten older. This sparked a realization about the passage of time. It made me reflect on my own need to become more mature and supportive, so she can finally rest and be cared for." },
  //poem19:{ type:"digital", title:"Lantern and You", play:"https://varsharaj2199-hub.github.io/NID_VARSHA-RAJ_P5.JS/Week%202%20Assignment%20Revised/", screenshots:["img/Game Poems/ss54.png","img/Game Poems/ss55.png"], description:"There are two characters, one boy and another girl. The girl is waiting for boy in the very last scene. Interaction happens by pressing right arrow key, so the boy, who appears on the first scene has to move from one frame to the very last frame. After he reaches the last frame, his movement stops when he meets the girl , initiating exchange of dialogues between these characters. At the very end, by pressing space lanterns starts to pop up from the bottom of the frame." },
  ...
  pong9:{ type:"digital", title:"Pong of Parallelism", play:"https://sunxxkei.itch.io/pong-of-parallelism", screenshots:["img/Pong/ss40.png","img/Pong/ss41.png","img/Pong/ss42.png"], description:"The two paddles for each players symbolize body and mind respectively- the bright visible one that the player controls is body and the glowing one that bounces the ball back is supposed to be the mind.\nHere the mind and body work independently- both at their own speed and they never interact but also together, as they’re gonna move in the same direction always. But parallelism implies body is an extended thing- which is why here the paddle that represents body doesn’t actually perform the main interaction (bouncing the ball) but instead in a shell that merely obeys what the player instructs it to." },
  pong10:{ type:"digital", title:"Malism Pong", play:"https://wrath6565.github.io/Navneet_NID_construction_test/Animation/day10/Pong_MOD_try_2/", screenshots:["img/Pong/ss43.png","img/Pong/ss44.png","img/Pong/ss45.png","img/Pong/ss46.png","img/Pong/ss47.png"], description:"Malism Pong is a twisted reinterpretation of the classic Pong, inspired by the belief that the world is inherently evil. You control your paddle with the arrow keys and the second player uses W and S. Every time a player hits the main ball, it creates an “evil ball” — a red, hostile version that drains your points on contact and can push your score into the negatives. You can choose to avoid it, but doing so gives the other player a point.\nAs time passes, each evil ball multiplies. Their numbers grow slowly at first, then rapidly, filling the screen until the entire space turns red. When the swarm fully takes over, the game ends with your inevitable death. It’s a gameplay loop where every action — even survival — invites more corruption, echoing the idea that evil spreads no matter what you do." },
