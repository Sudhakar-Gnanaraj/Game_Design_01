...
const gameData = {
  ...
  poem3:{ type:"digital", title:"Soul Ascend", play:"https://sagarsigroha.itch.io/soul-ascend", screenshots:["img/GamePoemSagar/ss5.png","img/GamePoemSagar/ss6.png"], description:"In Soul Ascend, you guide a glowing soul through realms of color and energy.<br>Move with your mouse, collect petals of awakening, and avoid the distractions that pull you down.<br>Each chakra you awaken brightens your spirit until all dissolve into pure light." },
  poem4:{ type:"digital", title:"A Sigh by the River.", play:"https://thejackofhearts.itch.io/a-sigh-by-the-river-game-poem", screenshots:["img/GamePoemAashishA/ss11.png","img/GamePoemAashishA/ss12.png","img/GamePoemAashishA/ss13.png","img/GamePoemAashishA/ss14.png"], description:"Use left Mouse Button Clicks and Right Arrow Key to progress.<br>A short, atmospheric game poem about experiencing a major festival as nothing more than a distant, digital echo.<br>In A Sigh by the River, you play as an individual living in a region where Diwali is not celebrated. The game is a linear, symbolic journey capturing the specific, hollow feeling of a holiday existing only on your phone screen.<br><br>A Sigh by the River is a 7-minute, linear art game. It uses simple mechanics (repeated clicking, driving, UI interaction) to explore complex themes of cultural detachment, digital solitude, and the hollowness of performing a celebration you don't experience.<br><br><b>Genre:</b> Game Poem / Narrative Art Game<br><br>The Story:<br>The story opens with the player alone in a paddy field. The first interaction is a close-up where the player must repeatedly click the mouse to light their cigarette. Each click advances a single frame of the flame, from a spark to a full light. This action is a metaphor for a firework; it's the only time in the game the player directly interacts with creating light, a symbolic, solitary stand-in for the missing celebration.<br>This quiet, personal "firework" is immediately interrupted when the player is reminded of the actual festival not by lights or sounds, but by a buzz on their phone.<br>From there, A few key moments and metaphors to show this collective, regional experience.<br>As the player drives through the silent city, all the house windows display chat boxes. Inside these boxes, people are simply wishing each other "Happy Diwali" instead of celebrating. This is a visual statement that for this entire city/state, the massive festival has been reduced to a digital notification, a performance of wishes, rather than a real-world celebration.<br>After stopping by a river, the player partakes in this same digital ritual, sending out "Happy Diwali" wishes to everyone. They then let out a sigh, which captures that feeling of participating in something hollow.<br>This sigh leads to the climax, the player sees fireworks in the sky, but they're all playing in reverse. This final metaphor symbolizes that the spirit of the holiday doesn't just feel absent for them, it's culturally absent from the whole area. The celebration is literally being undone, or "un-happening," in their world." },
  poem5:{ type:"digital", title:"Samurai and the Calf", play:"https://thejackofhearts.itch.io/samurai-and-the-calf", screenshots:["img/GamePoemAashishA/ss15.png","img/GamePoemAashishA/ss16.png"], description:"In the game, you play as Tsumu, a young samurai living a peaceful life in a small hut with her spirited pet calf, Kiko.<br>The game is a 5 minute, low-stakes, and deeply wholesome experience. It focuses on atmosphere, beautiful visuals, and a heartwarming narrative. The game concludes as you reunite with Kiko, pet him to calm him, and walk back home, now accompanied by your new, tiny, fluttering companion.<br><br>Genre: Narrative Adventure / Exploration" },
